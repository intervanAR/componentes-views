...
var autogestionComponents = require('@hugo-85/autogestion-components');
var PhoneIcon = require('@material-ui/icons/Phone');
...
var PhoneIcon__default = /*#__PURE__*/_interopDefaultLegacy(PhoneIcon);
var MaskedInput__default = /*#__PURE__*/_interopDefaultLegacy(MaskedInput);
var countries__default = /*#__PURE__*/_interopDefaultLegacy(countries);
...
var styles = function styles(theme) {
  return _objectSpread2({}, autogestionComponents.PageStyle(theme));
};
...
var TextMaskCustom = function TextMaskCustom(props) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(MaskedInput__default['default'], _extends({}, other, {
...
function Profile(props) {
  ...
  var _useState3 = React.useState(props.tipos_documentos || []),
      _useState4 = _slicedToArray(_useState3, 1),
      tipos_documentos = _useState4[0];

  var countriesList = Object.keys(countries__default['default'].countries);
  ...
  var getGeofData = function getGeofData(data) {
    setLoading(true);
    Axios__default['default'].get("https://apis.datos.gob.ar/georef/api/provincias?campos=id,nombre").then(function (resp) {
      ...
      if (data.pais === "AR" && data.provincia) {
        ...
        Axios__default['default'].get("https://apis.datos.gob.ar/georef/api/localidades?provincia=".concat(id, "&campos=id,nombre,municipio&max=2000")).then(function (resp) {
  ...
  var handleChangeProvincia = function handleChangeProvincia(nombre) {
    ...
    Axios__default['default'].get("https://apis.datos.gob.ar/georef/api/localidades?provincia=".concat(nombre, "&campos=id,nombre,municipio&max=2000")).then(function (resp) {
      var locs = resp.data.localidades;
      locs.sort(function (a, b) {
        return a.nombre > b.nombre ? 1 : -1;
  ...
  return /*#__PURE__*/React__default['default'].createElement(autogestionComponents.BlockComponent, {
    blocking: loading
  }, /*#__PURE__*/React__default['default'].createElement(autogestionComponents.Header, _extends({}, headerProps, {
    showTitle: true
  }), /*#__PURE__*/React__default['default'].createElement("div", null)), /*#__PURE__*/React__default['default'].createElement(autogestionComponents.MessageComponent, message), /*#__PURE__*/React__default['default'].createElement("div", {
    className: classes.wrapper
  }, /*#__PURE__*/React__default['default'].createElement(core.Grid, {
    container: true,
    spacing: 4
  }, /*#__PURE__*/React__default['default'].createElement(autogestionComponents.Card, {
    className: classes.card
  }, /*#__PURE__*/React__default['default'].createElement(autogestionComponents.CardHeader, null, "Datos Personales"), /*#__PURE__*/React__default['default'].createElement(autogestionComponents.CardBody, null, /*#__PURE__*/React__default['default'].createElement("form", {
    autoComplete: "off",
    className: classes.root
  }, /*#__PURE__*/React__default['default'].createElement(core.Grid, {
    container: true
  }, /*#__PURE__*/React__default['default'].createElement(autogestionComponents.GridItem, {
    xs: 12,
    sm: 8
  }, /*#__PURE__*/React__default['default'].createElement(autogestionComponents.CustomInput, {
  ...
  }, "Tipo Documento"), /*#__PURE__*/React__default['default'].createElement(core.Select //native {...this.bindValue('tipo_documento')}
  , {
    id: "tipo_documento",
    name: "tipo_documento",
    inputProps: {
    ...
    getOptionLabel: function getOptionLabel(option) {
      return !option ? "---" : countries__default['default'].countries[option].name;
    },
    value: data.pais,
    ...
    renderInput: function renderInput(params) {
      return /*#__PURE__*/React__default['default'].createElement(core.TextField, _extends({}, params, {
    ...
    xs: 12,
    sm: 6
  }, data.pais === "AR" ? provincias.length > 0 ? /*#__PURE__*/React__default['default'].createElement(Autocomplete__default['default'], {
    id: "provincia",
    name: "provincia",
    required: true,
  ...
  }) : /*#__PURE__*/React__default['default'].createElement("div", null) : /*#__PURE__*/React__default['default'].createElement(autogestionComponents.CustomInput, {
    labelText: "Provincia",
    id: "provincia",
    formControlProps: {
      fullWidth: true
    ...
    xs: 12,
    sm: 9
  }, data.pais === "AR" ? localidades.length > 0 ? /*#__PURE__*/React__default['default'].createElement(Autocomplete__default['default'], {
    id: "localidad",
    name: "localidad",
    ...
    xs: 12,
    sm: 4
  }, /*#__PURE__*/React__default['default'].createElement(core.FormControl, null, /*#__PURE__*/React__default['default'].createElement(core.InputLabel, {
    htmlFor: "telefono1"
  }, "Telefono1"), /*#__PURE__*/React__default['default'].createElement(core.Input, {
    ...
    startAdornment: /*#__PURE__*/React__default['default'].createElement(core.InputAdornment, {
      position: "start"
    }, /*#__PURE__*/React__default['default'].createElement(PhoneIcon__default['default'], null), " +")
  }))), /*#__PURE__*/React__default['default'].createElement(autogestionComponents.GridItem, {
    xs: 12,
    sm: 4
  }, /*#__PURE__*/React__default['default'].createElement(core.FormControl, null, /*#__PURE__*/React__default['default'].createElement(core.InputLabel, {
    htmlFor: "telefono2"
  }, "Telefono2"), /*#__PURE__*/React__default['default'].createElement(core.Input, {
  ...
  }))), parametros && (parametros === null || parametros === void 0 ? void 0 : (_parametros$AU_PERFIL = parametros.AU_PERFIL_CAMPO1) === null || _parametros$AU_PERFIL === void 0 ? void 0 : _parametros$AU_PERFIL.valor) === "S" ? /*#__PURE__*/React__default['default'].createElement(autogestionComponents.GridItem, {
    xs: 12,
    sm: 6
  }, /*#__PURE__*/React__default['default'].createElement(autogestionComponents.CustomInput, {
  ...
  })) : null, parametros && (parametros === null || parametros === void 0 ? void 0 : (_parametros$AU_PERFIL2 = parametros.AU_PERFIL_CAMPO2) === null || _parametros$AU_PERFIL2 === void 0 ? void 0 : _parametros$AU_PERFIL2.valor) === "S" ? /*#__PURE__*/React__default['default'].createElement(autogestionComponents.GridItem, {
    xs: 12,
    sm: 6
  }, /*#__PURE__*/React__default['default'].createElement(autogestionComponents.CustomInput, {
  ...
  })) : null, parametros && (parametros === null || parametros === void 0 ? void 0 : (_parametros$AU_PERFIL3 = parametros.AU_PERFIL_CAMPO3) === null || _parametros$AU_PERFIL3 === void 0 ? void 0 : _parametros$AU_PERFIL3.valor) === "S" ? /*#__PURE__*/React__default['default'].createElement(autogestionComponents.GridItem, {
    xs: 12,
    sm: 6
  }, /*#__PURE__*/React__default['default'].createElement(autogestionComponents.CustomInput, {
  ...
  })) : null), /*#__PURE__*/React__default['default'].createElement(autogestionComponents.GridContainer, {
    container: true,
    direction: "row",
    justify: "flex-end",
    alignItems: "flex-start"
  }, /*#__PURE__*/React__default['default'].createElement(autogestionComponents.GridItem, null, /*#__PURE__*/React__default['default'].createElement(autogestionComponents.Button, {
    onClick: saveData,
    className: classes2.saveButton
  }, "Guardar"))))), /*#__PURE__*/React__default['default'].createElement(autogestionComponents.CardFooter, null)))));
}

var Profile$1 = styles$1.withStyles(styles)(Profile);
